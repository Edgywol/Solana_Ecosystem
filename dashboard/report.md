...
**Generated At (UTC):** `2026-08-22T12:32:04.904456+00:00`  
**Cluster Health:** `🟢 Operational`  
**Current Epoch:** `1020` (`65.41%` complete, ~15.3h remaining)

## 📌 Executive Summary
Solana mainnet-beta is currently processing **3,158 TPS** (non-vote TPS: ~1,282) with an average slot time of **367.5ms**. SOL is trading at **$94.15** (+4.34% 24h) with total ecosystem TVL of **$5.54B** and 24h DEX volume of **$3.60B**. The network is secured by **686 active validators** with a Nakamoto coefficient of **18**.
...
|---|---|---|---|
| **SOL Price** | `$94.15` | `+4.34%` | Market Cap: `$54.91B` |
| **Network Throughput** | `3,158.4 TPS` | `15m Avg: 3,428 TPS` | True Non-Vote: `1,282 TPS` |
| **Slot Duration** | `367.5ms` | `Target: 400.0ms` | Current Slot: `440922563` |
| **DeFi TVL** | `$5.539B` | `+3.89%` | Capital Turnover: `0.65x` |
| **24h DEX Volume** | `$3.601B` | — | High on-chain velocity |
| **Stablecoin Supply** | `$15.808B` | — | USDC/USDT on Solana |
| **Real Economic Value (REV)** | `$1,475,479 / day` | — | Base + Priority + Jito MEV tips |
| **Active Validators** | `686 nodes` | `Delinquent: 8` | Stake: `433.4M SOL` |
| **Nakamoto Coefficient** | `18` | `Top 10 Stake: 24.33%` | Min nodes to halt consensus |

## 🛡️ Top Validator Nodes by Activated Stake
| Rank | Validator Entity | Active Stake (SOL) | Stake Share | Commission | Last Vote Slot | Status |
|---|---|---|---|---|---|---|
| **#1** | `Validator CcaH..oTN1` | `17,066,372 SOL` | `3.94%` | `7%` | `440922563` | 🟢 Active |
| **#2** | `Validator he1i..uBtk` | `16,054,078 SOL` | `3.70%` | `0%` | `440922563` | 🟢 Active |
| **#3** | `Validator 3N7s..iD5g` | `12,175,413 SOL` | `2.81%` | `0%` | `440922563` | 🟢 Active |
| **#4** | `Validator Catz..Diqb` | `11,782,032 SOL` | `2.72%` | `5%` | `440922563` | 🟢 Active |
| **#5** | `Validator 26pV..3dJx` | `9,178,661 SOL` | `2.12%` | `7%` | `440922563` | 🟢 Active |
| **#6** | `Validator 51JB..UNAm` | `8,917,577 SOL` | `2.06%` | `10%` | `440922563` | 🟢 Active |
| **#7** | `Validator 8Gbw..F8iD` | `8,402,660 SOL` | `1.94%` | `0%` | `440922563` | 🟢 Active |
| **#8** | `Validator 9QU2..29mF` | `7,964,352 SOL` | `1.84%` | `7%` | `440922563` | 🟢 Active |
| **#9** | `Validator CvSb..wycB` | `7,357,821 SOL` | `1.70%` | `5%` | `440922563` | 🟢 Active |
| **#10** | `Validator Dumi..Zk4a` | `6,547,243 SOL` | `1.51%` | `0%` | `440922563` | 🟢 Active |
