...
**Generated At (UTC):** `2026-09-13T11:02:23.342446+00:00`  
**Cluster Health:** `🟢 Operational`  
**Current Epoch:** `1033` (`99.67%` complete, ~0.1h remaining)

## 📌 Executive Summary
Solana mainnet-beta is currently processing **3,326 TPS** (non-vote TPS: ~1,255) with an average slot time of **315.1ms**. SOL is trading at **$99.53** (-2.60% 24h) with total ecosystem TVL of **$5.85B** and 24h DEX volume of **$2.47B**. The network is secured by **677 active validators** with a Nakamoto coefficient of **18**.
...
|---|---|---|---|
| **SOL Price** | `$99.53` | `-2.60%` | Market Cap: `$58.37B` |
| **Network Throughput** | `3,325.9 TPS` | `15m Avg: 3,460 TPS` | True Non-Vote: `1,255 TPS` |
| **Slot Duration** | `315.1ms` | `Target: 400.0ms` | Current Slot: `446686575` |
| **DeFi TVL** | `$5.849B` | `-0.87%` | Capital Turnover: `0.42x` |
| **24h DEX Volume** | `$2.473B` | — | High on-chain velocity |
| **Stablecoin Supply** | `$16.114B` | — | USDC/USDT on Solana |
| **Real Economic Value (REV)** | `$1,027,148 / day` | — | Base + Priority + Jito MEV tips |
...
|---|---|---|---|---|---|---|
| **#1** | `Validator CcaH..oTN1` | `17,557,397 SOL` | `4.04%` | `7%` | `446686579` | 🟢 Active |
| **#2** | `Validator he1i..uBtk` | `16,359,842 SOL` | `3.76%` | `0%` | `446686579` | 🟢 Active |
| **#3** | `Validator 3N7s..iD5g` | `12,516,388 SOL` | `2.88%` | `0%` | `446686579` | 🟢 Active |
| **#4** | `Validator Catz..Diqb` | `11,367,276 SOL` | `2.61%` | `5%` | `446686579` | 🟢 Active |
| **#5** | `Validator 8Gbw..F8iD` | `9,667,435 SOL` | `2.22%` | `0%` | `446686579` | 🟢 Active |
| **#6** | `Validator 26pV..3dJx` | `9,234,081 SOL` | `2.12%` | `7%` | `446686579` | 🟢 Active |
| **#7** | `Validator 51JB..UNAm` | `9,021,415 SOL` | `2.07%` | `10%` | `446686579` | 🟢 Active |
| **#8** | `Validator 9QU2..29mF` | `7,357,834 SOL` | `1.69%` | `7%` | `446686579` | 🟢 Active |
| **#9** | `Validator CvSb..wycB` | `6,941,562 SOL` | `1.60%` | `5%` | `446686579` | 🟢 Active |
| **#10** | `Validator Dumi..Zk4a` | `6,551,099 SOL` | `1.51%` | `0%` | `446686579` | 🟢 Active |
