...
**Generated At (UTC):** `2026-09-24T11:03:46.190143+00:00`  
**Cluster Health:** `🟢 Operational`  
**Current Epoch:** `1041` (`68.91%` complete, ~9.9h remaining)

## 📌 Executive Summary
Solana mainnet-beta is currently processing **3,956 TPS** (non-vote TPS: ~1,441) with an average slot time of **265.2ms**. SOL is trading at **$113.44** (-3.39% 24h) with total ecosystem TVL of **$6.35B** and 24h DEX volume of **$2.68B**. The network is secured by **677 active validators** with a Nakamoto coefficient of **18**.
...
|---|---|---|---|
| **SOL Price** | `$113.44` | `-3.39%` | Market Cap: `$66.64B` |
| **Network Throughput** | `3,955.7 TPS` | `15m Avg: 4,284 TPS` | True Non-Vote: `1,441 TPS` |
| **Slot Duration** | `265.2ms` | `Target: 400.0ms` | Current Slot: `450009693` |
| **DeFi TVL** | `$6.354B` | `-2.74%` | Capital Turnover: `0.42x` |
| **24h DEX Volume** | `$2.683B` | — | High on-chain velocity |
| **Stablecoin Supply** | `$17.100B` | — | USDC/USDT on Solana |
| **Real Economic Value (REV)** | `$1,116,329 / day` | — | Base + Priority + Jito MEV tips |
| **Active Validators** | `677 nodes` | `Delinquent: 10` | Stake: `439.8M SOL` |
| **Nakamoto Coefficient** | `18` | `Top 10 Stake: 24.39%` | Min nodes to halt consensus |

## 🛡️ Top Validator Nodes by Activated Stake
| Rank | Validator Entity | Active Stake (SOL) | Stake Share | Commission | Last Vote Slot | Status |
|---|---|---|---|---|---|---|
| **#1** | `Validator CcaH..oTN1` | `17,843,203 SOL` | `4.06%` | `7%` | `450009692` | 🟢 Active |
| **#2** | `Validator he1i..uBtk` | `15,838,937 SOL` | `3.60%` | `0%` | `450009692` | 🟢 Active |
| **#3** | `Validator 3N7s..iD5g` | `12,360,465 SOL` | `2.81%` | `0%` | `450009692` | 🟢 Active |
| **#4** | `Validator Catz..Diqb` | `11,264,812 SOL` | `2.56%` | `5%` | `450009692` | 🟢 Active |
| **#5** | `Validator 8Gbw..F8iD` | `10,335,638 SOL` | `2.35%` | `0%` | `450009692` | 🟢 Active |
| **#6** | `Validator 26pV..3dJx` | `9,226,124 SOL` | `2.10%` | `7%` | `450009692` | 🟢 Active |
| **#7** | `Validator 51JB..UNAm` | `9,158,950 SOL` | `2.08%` | `10%` | `450009692` | 🟢 Active |
| **#8** | `Validator 9QU2..29mF` | `7,600,816 SOL` | `1.73%` | `7%` | `450009692` | 🟢 Active |
| **#9** | `Validator CvSb..wycB` | `7,090,585 SOL` | `1.61%` | `5%` | `450009692` | 🟢 Active |
| **#10** | `Validator Dumi..Zk4a` | `6,557,340 SOL` | `1.49%` | `0%` | `450009692` | 🟢 Active |
